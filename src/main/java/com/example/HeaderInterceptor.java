...
public class HeaderInterceptor implements Interceptor {
	 ...
	 */
	private HeaderInterceptor(String separator) {
	...
	public Event intercept(Event event) {
		Map<String,String> headerKeys = new HashMap();
		headerKeys.put("key","zz-"+String.valueOf(new Random().nextInt(5)));
		
		event.getHeaders();
		event.setHeaders(headerKeys);
		return event;
...
//		return event;
	...
	public static class Builder implements Interceptor.Builder {
		...
		public Interceptor build() {
			return new HeaderInterceptor(this.separator);
		}
